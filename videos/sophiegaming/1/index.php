...
<body>
        <div style="text-align:center;">
            ...
            <object type="application/x-shockwave-flash" data="../../resources/player.swf" width="384" height="256">
                ...
                <param name='flashvars' value='filename=sophiegaming-1-1.flv'>
            </object>
			</div>
            PART 1 - <a href="index2.html">PART 2</a>
            <h1>starting 2023 by playing TF2 on potato PCs</h1>
        ...
        <table>
            <tr>
                ...
                <td>
                    <a href="../">sophieGaming</a>
				</td>
				<td style="padding-left:20px;">
					<h2>Description</h2>
					how else should we spend our first day of the new year than acting like it's 2012 with 2 old Windows 7 PCs and TF2 on mastercomfig's lowest offerings..?
				</td>
            </tr>
            </table>
    </body>
